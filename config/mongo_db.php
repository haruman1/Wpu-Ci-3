...
$config['mongo_db']['active'] = 'brd';

$config['mongo_db']['brd']['hostname'] = 'breakdowndb-dvkkp.mongodb.net';
$config['mongo_db']['brd']['port'] = '27017';
$config['mongo_db']['brd']['username'] = 'qq';
$config['mongo_db']['brd']['password'] = 'haruman1442';
$config['mongo_db']['brd']['database'] = 'BreakdownDb';
$config['mongo_db']['brd']['db_debug'] = TRUE;
$config['mongo_db']['brd']['write_concerns'] = (int) 1;
$config['mongo_db']['brd']['journal'] = TRUE;
$config['mongo_db']['brd']['read_preference'] = NULL;
$config['mongo_db']['brd']['read_preference_tags'] = NULL;
